    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'users',
                'indexes': [models.Index(fields=['employee_code'], name='users_employe_ac6b2f_idx'), models.Index(fields=['email'], name='users_email_4b85f2_idx'), models.Index(fields=['department'], name='users_departm_d50da8_idx')],
            },
            managers=[
